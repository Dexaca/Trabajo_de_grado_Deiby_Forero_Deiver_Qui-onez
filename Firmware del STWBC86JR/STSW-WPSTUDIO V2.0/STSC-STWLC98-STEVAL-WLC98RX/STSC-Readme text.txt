...
Please refer to the STEVAL-WLC98RX user manual for instructions on how to load the "STWLC98_STSC_step_sequencer.bin" file and run the STSC protocol using the STSW-WPSTUDIO software.
